...
export const knowledgeTopics: { keywords: string[]; answer: string }[] = [
  ...
  },
  {
    ...
    answer: `Learn about our innovation program at /innovation-hub (public info). Signed-in innovators submit at /portal/innovation/submit in their private workspace.`,
  },
  {
  ...
  },
  {
    ...
    answer:
      "The company blog at /blog is published by TechFlare on the public website. Members share personal testimonials in their workspace — not blog posts.",
  },
  {
